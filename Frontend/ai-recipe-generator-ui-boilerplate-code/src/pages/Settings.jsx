...
const Settings = () => {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const {user, preferences: userPreferences} = response.data.data;
            ...
            if (userPreferences) {
                setPreferences({
                    ...
                    default_servings: userPreferences.default_servings || 4,
                    measurement_unit: userPreferences.measurement_unit || 'metric'
                });
            }   
    } catch (error) {
