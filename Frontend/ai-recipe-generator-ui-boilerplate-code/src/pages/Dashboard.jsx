        ...
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                setStats({
                    ...
                    mealsThisWeek:
                        mealPlanRes.data.data.stats.meals_this_week || mealPlanRes.data.data.stats.this_week_count || 0
                });


                setRecentRecipes(
                    recentRes.data?.data?.recipes || recentRes.data?.data || []
                );


                setUpcomingMeals(
                    upcomingRes.data?.data?.meals || upcomingRes.data?.data || []
                );
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <Link
                        to="/generate"
                        className="bg-gradient-to-r from-emerald-50 to-emerald-100 text-emerald-600 p-6 rounded-xl shadow-sm hover:shadow-md transition-all group"
                    >
